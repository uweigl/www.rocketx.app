...
RX = {
 "en": dict(cart=u"Server-side, shared live across the team, visible to your reps",
            app=u"Web app in any browser plus native iOS &amp; Android, catalogue cached offline",
 ...
 "de": dict(cart=u"Serverseitig, live im Team geteilt, für Ihren Außendienst sichtbar",
            app=u"Web-App in jedem Browser plus native iOS- &amp; Android-Apps, Katalog offline im Gerät",
 ...
 "es": dict(cart=u"En el servidor, compartido en vivo por el equipo, visible para tus vendedores",
            app=u"Web app en cualquier navegador más apps nativas iOS y Android, catálogo en el dispositivo sin señal",
 ...
 "nl": dict(cart=u"Op de server, live gedeeld door het team, zichtbaar voor je buitendienst",
            app=u"Webapp in elke browser plus native iOS- &amp; Android-apps, catalogus offline op het toestel",
 ...
 "fr": dict(cart=u"Côté serveur, partagé en direct par l’équipe, visible pour vos commerciaux",
            app=u"Web app dans tout navigateur plus apps natives iOS &amp; Android, catalogue en local hors connexion",
...
EDGE = {
 "en": [u"<b>A true native app experience:</b> iOS and Android apps built for B2B ordering — not a website wrapped in a shell.",
        u"<b>One cart on every surface:</b> a full web app in any browser on any computer or device, plus the native apps — the same server-side cart everywhere, cached on the device and synced back the moment the connection returns.",
        ...
        u"<b>Implemented by the people who built it:</b> RocketX sets the platform up for you directly — no agency in between, no agency fees, no hand-offs where quality slips, and support from the team that knows the code.",
 ...
 "de": [u"<b>Echtes natives App-Erlebnis:</b> iOS- und Android-Apps, gebaut für B2B-Bestellungen — keine Website in einer App-Hülle.",
        u"<b>Ein Warenkorb auf jeder Oberfläche:</b> eine vollwertige Web-App in jedem Browser auf jedem Rechner oder Gerät, dazu die nativen Apps — überall derselbe serverseitige Warenkorb, im Gerät gecacht und synchronisiert, sobald die Verbindung zurück ist.",
        ...
        u"<b>Implementiert von denen, die es gebaut haben:</b> RocketX richtet die Plattform direkt für Sie ein — keine Agentur dazwischen, keine Agenturhonorare, keine Übergaben, an denen Qualität verloren geht, und Support vom Team, das den Code kennt.",
 ...
 "es": [u"<b>Una experiencia nativa de verdad:</b> apps iOS y Android construidas para el pedido B2B — no una web envuelta en una app.",
        u"<b>Un solo carrito en cada superficie:</b> una web app completa en cualquier navegador, en cualquier computadora o dispositivo, más las apps nativas — el mismo carrito en el servidor en todas partes, guardado en el dispositivo y sincronizado en cuanto vuelve la conexión.",
        ...
        u"<b>Implementado por quienes lo construyeron:</b> RocketX configura la plataforma directamente para ti — sin agencia de por medio, sin honorarios de agencia, sin traspasos donde se pierde calidad, y soporte del equipo que conoce el código.",
 ...
 "nl": [u"<b>Een echte native app-ervaring:</b> iOS- en Android-apps gebouwd voor B2B-bestellen — geen website in een app-schil.",
        u"<b>Eén winkelwagen op elk oppervlak:</b> een volwaardige webapp in elke browser op elke computer of elk toestel, plus de native apps — overal dezelfde serverwagen, gecachet op het toestel en gesynct zodra de verbinding terug is.",
        ...
        u"<b>Geïmplementeerd door de makers zelf:</b> RocketX richt het platform rechtstreeks voor je in — geen bureau ertussen, geen bureaukosten, geen overdrachten waar kwaliteit verloren gaat, en support van het team dat de code kent.",
 ...
 "fr": [u"<b>Une vraie expérience native :</b> des apps iOS et Android construites pour la commande B2B — pas un site web dans une coque.",
        u"<b>Un seul panier sur chaque surface :</b> une web app complète dans tout navigateur, sur tout ordinateur ou appareil, plus les apps natives — partout le même panier côté serveur, gardé en local et synchronisé dès que la connexion revient.",
        ...
        u"<b>Implémenté par ceux qui l’ont construit :</b> RocketX met la plateforme en place directement pour vous — pas d’agence entre nous, pas d’honoraires d’agence, pas de passages de relais où la qualité se perd, et un support par l’équipe qui connaît le code.",
