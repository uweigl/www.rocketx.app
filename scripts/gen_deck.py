...
C["nl"] = dict(
    ...
    forwho="Voor bedrijven met 15–250 miljoen euro omzet en veel groothandelsbestellingen",
    date="Editie 2026",
    xsh="Op één pagina",
    ...
    native=[("Nabestellen is een gewoonte, geen zoektocht", "De meeste B2B-orders zijn herhaalorders. In een browser moet de inkoper elke keer de bladwijzer zoeken, de site laden en inloggen. Een app is één tik, al ingelogd — die wrijving verdwijnt bij elke nabestelling, blijvend."),
            ...
            ("Hij overleeft het wegvallen van bereik", "Hallen met stalen wanden en landelijke routes kosten bereik. Catalogus, prijzen en winkelwagen blijven lokaal en synchroniseren zodra de verbinding terug is.")],
