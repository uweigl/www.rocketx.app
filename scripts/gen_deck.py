...
C["en"] = dict(
    ...
    nf=[('You sell mainly to consumers', 'RocketX is built for B2B and wholesale ordering.'),
...
C["de"] = dict(
    ...
    nf=[('Sie verkaufen überwiegend an Endkunden', 'RocketX ist für B2B- und Großhandelsbestellungen gebaut.'),
...
C["es"] = dict(
    ...
    nf=[('Vendes sobre todo a consumidores', 'RocketX está hecho para pedidos B2B y mayoristas.'),
