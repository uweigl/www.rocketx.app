...
C["de"] = dict(
    ...
    cma="Die Datenschutz- und Sicherheitsprüfung ist meist der langsamste Teil einer Evaluation. Der übliche Grund: Ein US-Anbieter soll erklären, warum europäische Daten in Amerika gut aufgehoben sind. Wir haben das vermieden, indem wir es nicht tun.",
...
C["es"] = dict(
    ...
    cma="La revisión de seguridad y datos suele ser la parte más lenta de una evaluación. El motivo habitual: un proveedor estadounidense tratando de explicar por qué los datos europeos están bien en América. Lo evitamos no haciéndolo.",
...
C["nl"] = dict(
    ...
    cma="De toets op gegevens en beveiliging is meestal het traagste deel van een beoordeling. De gebruikelijke reden: een Amerikaanse leverancier moet uitleggen waarom Europese gegevens in Amerika prima zitten. Wij hebben dat vermeden door het niet te doen.",
