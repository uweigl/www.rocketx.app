...
C["en"] = dict(
    ...
    eu=[("Counterparty", "An Irish company, incorporated and operating in the European Union under EU law, separate from the US entity."),
        ...
        ("Certifications", "EU facilities certified to ISO/IEC 27001:2022 and BSI C5 Type 2. Certificates attach to the agreement."),
    ...
    us=[("Counterparty", "RocketX LLC, the United States entity. Same platform, same commitments, governed where you are."),
        ...
        ("Certifications", "Same provider and controls. Its ISO/IEC 27001 scope names the EU sites, so we do not claim it here."),
...
C["de"] = dict(
    ...
    eu=[("Vertragspartner", "Eine irische Gesellschaft, gegründet und tätig in der Europäischen Union nach EU-Recht, getrennt von der US-Gesellschaft."),
        ...
        ("Zertifizierungen", "EU-Rechenzentren mit ISO/IEC 27001:2022 und BSI C5 Typ 2. Die Zertifikate sind Vertragsbestandteil."),
    ...
    us=[("Vertragspartner", "Die RocketX LLC, die US-Gesellschaft. Dieselbe Plattform, dieselben Zusagen, geltendes Recht an Ihrem Sitz."),
        ...
        ("Zertifizierungen", "Derselbe Anbieter, dieselben Kontrollen. Das ISO/IEC-27001-Zertifikat nennt die EU-Standorte, also beanspruchen wir es hier nicht."),
...
C["es"] = dict(
    ...
    eu=[("Contraparte", "Una sociedad irlandesa, constituida y operativa en la Unión Europea bajo derecho de la UE, separada de la entidad estadounidense."),
        ...
        ("Certificaciones", "Centros de datos de la UE con ISO/IEC 27001:2022 y BSI C5 Tipo 2. Los certificados se adjuntan al contrato."),
    ...
    us=[("Contraparte", "RocketX LLC, la entidad estadounidense. La misma plataforma, los mismos compromisos, con la ley de donde estás."),
        ...
        ("Certificaciones", "El mismo proveedor y los mismos controles. Su ISO/IEC 27001 cubre los centros de la UE, así que no lo reclamamos aquí."),
...
C["nl"] = dict(
    ...
    eu=[("Wederpartij", "Een Ierse vennootschap, opgericht en actief in de Europese Unie naar EU-recht, los van de Amerikaanse entiteit."),
        ...
        ("Certificeringen", "EU-datacenters met ISO/IEC 27001:2022 en BSI C5 Type 2. De certificaten horen bij het contract."),
    ...
    us=[("Wederpartij", "RocketX LLC, de Amerikaanse vennootschap. Hetzelfde platform, dezelfde toezeggingen, recht van je eigen vestigingsplaats."),
        ...
        ("Certificeringen", "Dezelfde provider en controles. Het ISO/IEC 27001-certificaat noemt de EU-locaties, dus claimen we het hier niet."),
