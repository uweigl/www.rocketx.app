...
C["en"] = dict(
    ...
    caps=[("Millions of SKUs, sub-second search", "Filter and order across millions of items in milliseconds — performance other platforms do not match at this scale."),
          ("Native iOS and Android apps", "Purpose-built for B2B ordering, not a wrapped website. Full catalog in the buyer's pocket."),
          ("Unlimited seats and users", "Every employee, rep, and authorised customer gets full access. No per-user fees, no rationing."),
          ...
          ("Deep ERP and CRM integration", "Two-way sync with NetSuite, SAP, Microsoft Dynamics, Epicor, and other major systems.")],
    ...
    terms=[("Flat fee, never a percentage of GMV", "Platform cost does not rise because your order volume did. Growth is not taxed."),
           ("Unlimited seats included", "No per-user pricing to negotiate or ration as the team grows."),
...
C["de"] = dict(
    ...
    caps=[("Millionen SKUs, Suche unter einer Sekunde", "Filtern und Bestellen aus Millionen Artikeln in Millisekunden — eine Performance, die andere Plattformen in dieser Größenordnung nicht erreichen."),
          ...
          ("Unbegrenzte Plätze und Nutzer", "Jeder Mitarbeiter, Vertriebler und autorisierte Kunde erhält vollen Zugriff. Keine Gebühren pro Nutzer, keine Rationierung."),
          ...
          ("Tiefe ERP- und CRM-Integration", "Bidirektionale Synchronisation mit NetSuite, SAP, Microsoft Dynamics, Epicor und weiteren führenden Systemen.")],
    ...
    terms=[("Pauschalgebühr, niemals ein Umsatzprozentsatz", "Die Plattformkosten steigen nicht, weil Ihr Bestellvolumen gestiegen ist. Wachstum wird nicht besteuert."),
           ("Unbegrenzte Plätze inklusive", "Keine Preisverhandlung pro Nutzer und keine Rationierung, wenn das Team wächst."),
...
C["es"] = dict(
    ...
    caps=[("Millones de SKUs, búsqueda en menos de un segundo", "Filtre y pida entre millones de artículos en milisegundos — un rendimiento que otras plataformas no igualan a esta escala."),
          ...
          ("Usuarios y accesos ilimitados", "Cada empleado, vendedor y cliente autorizado tiene acceso completo. Sin tarifas por usuario, sin racionar."),
          ...
          ("Integración profunda con ERP y CRM", "Sincronización bidireccional con NetSuite, SAP, Microsoft Dynamics, Epicor y otros sistemas principales.")],
    ...
    terms=[("Tarifa fija, nunca un porcentaje del GMV", "El costo de la plataforma no sube porque su volumen de pedidos lo haya hecho. El crecimiento no se grava."),
           ("Usuarios ilimitados incluidos", "Sin precios por usuario que negociar ni racionar cuando el equipo crece."),
