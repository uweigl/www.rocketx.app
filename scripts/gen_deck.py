...
C["en"] = dict(
    ...
    at=['Data processing agreement, with roles written down', 'Current subprocessor list, with change notice', "Hosting regions for your data, named in writing", 'Uptime and support commitments, by tier', 'Retention, deletion and backup policy', 'Export in open formats, at any time and on exit'],
...
C["de"] = dict(
    ...
    at=['Auftragsverarbeitungsvertrag mit schriftlich fixierten Rollen', 'Aktuelle Liste der Unterauftragsverarbeiter, mit Änderungsmitteilung', "Hosting-Regionen Ihrer Daten, schriftlich benannt", 'Zusagen zu Verfügbarkeit und Support, nach Stufe', 'Aufbewahrungs-, Lösch- und Backup-Richtlinie', 'Export in offenen Formaten, jederzeit und beim Ausstieg'],
...
C["es"] = dict(
    ...
    at=['Acuerdo de tratamiento de datos, con los roles por escrito', 'Lista vigente de subencargados, con aviso de cambios', "Regiones de alojamiento de tus datos, por escrito", 'Compromisos de disponibilidad y soporte, por nivel', 'Política de retención, borrado y copias de seguridad', 'Exportación en formatos abiertos, en cualquier momento y al salir'],
